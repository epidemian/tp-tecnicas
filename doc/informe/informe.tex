...
\author{	Bruno, Tomás ; \textit{Padrón Nro. 88.449}                     \\
			...
			Ferreiro, Demian ; \textit{Padrón Nro. }                     \\
...
\section{Hipotésis}
	\begin{enumerate}
		...
		\item Se pueden romper tanto las máquinas de control de calidad como las que son 
		...
		\item Tanto los precios de la materia prima como los de los productos varían todas las 
...
\section{Vista Lógica}
	\subsection{Producción}
		...
		%La estructura de la producción es el esqueleto de todo el juego. 
