...
\section{Vista Lógica}
	\subsection{Producción}
		...
		En el diagrama de clases se puede observar a grandes rasgos como se implement\'o la decisión de que cada producto guarda un historial: cada producto cuando es procesado por una maquina guarda la información acerca del tipo de maquina por el que fue procesado además de la materia de prima con la que fue creado . Para que esto sea realizado, existe un método process que esta redefinido en los distintos tipos de productionLineElements.
...
\section{Vista de Procesos}
	...
	El programa tiene un \'unico proceso. Por lo tanto, no existe ninguna comunicaci\'on entre procesos. 
