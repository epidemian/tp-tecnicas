...
public class GlobalTest {
	...
	public void setUp() throws Exception {
		...
		List<Ground> listGrounds = inputFactory
				.loadGrounds("test/global/ValidGroundList.xml");

		priceMap = new PriceMap(inputFactory
				.loadPrices("test/global/ValidPriceList.xml"));
		...
		warehouse = new RentedWarehouse(ground, budget, priceMap,
				validSequences);
		...
		this.validQualityControlMachineTypes = new ValidMachineTypes(
				inputFactory.loadProductionMachines("test/global/"
						+ "ValidQualityControlMachineList.xml"));

		this.validRawMaterials = new ValidRawMaterialTypes(
				inputFactory
	...
	public ProductionLine createLineProcessingFlail() {
		...
		InputProductionLineElement prodLineElement0 = new InputProductionLineElement(
				Direction.EAST);
		...
		OutputProductionLineElement prodLineElement3 = new OutputProductionLineElement();

		connectLineElements(prodLineElement0, prodLineElement1);
	...
	public void overallDay() throws Exception {
		...
		/*
		 * for(int i=0;i<4;i++) this.changePrices(i);
		 */
		...
		System.out.println("Warehouse products:"
				+ this.warehouse.getStorageArea().getProductsProduced().size());
